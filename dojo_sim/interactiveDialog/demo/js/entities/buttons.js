      ...
      init: function(x, y, width, height, label) {
          ...
          var myLabel = me.Renderable.extend({
              init: function(x,y,width, height, label) {
                  ...
                  this.font = new me.Font("Arial", this.fontSize, "black");
                  this.font.textAlign = "left";
                  this.font.textBaseline = "middle";
                  this.font.bold();
              ...
              draw: function(renderer){
                  ...
                  if (debugLevel > 1) console.log("TextUI: labelText: draw: ",this.pos.x, this.pos.y, this.panelWidth, this.panelHeight);

                  let textMeasure = this.font.measureText(renderer, "x");
                  if (debugLevel > 1) console.log("TextUI: labelText: draw: textMeasure: ", textMeasure.width, textMeasure.height);
                  ...
                  let charactersToRender = this.label.length;
                  ...
                  for (i = 0; i < charactersToRender; i+= charactersPerLine) {
                      ...
                      let strToRender = this.label.substring(i, i + charactersThisLine);
          ...
          this.LabelText = new myLabel(this.pos.x, this.pos.y, this.width, this.height, this.label);
