    ...
    addTextArea : function() {
      ...
      var textArea = new (me.Renderable.extend ({
          ...
          init : function() {
              ...
              this.synopsisText = 'You play the role of a dojo instructor.\
Sign up students and try to get your dojo skill level higher before you run out of funds.\
';
          ...
          draw : function (renderer) {
              ...
              for (i = 0; i < charactersToRender; i+= charactersPerLine) {
                  ...
                  this.font.draw (
                      renderer,
                      strToRender, // label
											me.game.viewport.width*.25,
                      //me.game.viewport.width/2,
                      me.game.viewport.height*.5  + (currentLineIndex * textMeasure.height));
